        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6 rounded">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800">Understanding Your Budgets</h3>
                        <div class="mt-2 text-sm text-blue-700">
                            <p>These are your <strong>Monthly Budgets</strong> - the actual budgets where you track spending for {{ $currentDate->format('F Y') }}. 
                               They come from your <strong>Templates</strong> (recurring monthly patterns) or are <strong>One-Time Budgets</strong> (specific to this month only).</p>
                        </div>
                    </div>
                </div>
            </div>
