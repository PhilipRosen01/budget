<x-guest-layout>
    <div class="mb-8 text-center">
        <div class="mx-auto w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-lg transform hover:scale-105 transition-transform duration-200" style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%);">
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <!-- Sign In Button -->
        <div class="pt-2">
            <button type="submit" class="w-full text-white font-semibold py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transform transition-all duration-150 hover:scale-[1.02] active:scale-[0.98] shadow-lg" style="background: linear-gradient(to right, #4f46e5 0%, #7c3aed 100%);">
                Sign In
            </button>
        </div>
    </form>
